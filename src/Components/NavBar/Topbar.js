      ...
      <div className="flex-1 ">
        <form className="flex items-center">
          <input
            ...
            className="border-2 py-2 px-2 w-[250px] rounded-tl-full rounded-bl-full border-slate-200	"
            type="text"
            name="text"
            id=""
          />
          <button
            className="btn btn-primary text-white  rounded-tr-full rounded-br-full"
            type="submit"
          >
            <Icon icon={ic_search_outline} size={30}></Icon>
          </button>
        </form>
      </div>
