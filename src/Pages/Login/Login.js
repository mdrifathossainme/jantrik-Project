...
const Login = () => {
  ...
  return (
    <div className="my-12">
      <div className={`lg:w-[470px]  ${resetFormToggle===false?"lg:h-[480px]":"lg:h-[300px]"} mx-auto border-2 px-12 py-8 rounded-md`}>
        <h1 className="text-2xl">{resetFormToggle===false? "Login":"Rset Password"} </h1>

        {resetFormToggle === false ?   <div>
          ...
          <h6 className=" mt-2"><span onClick={()=>setResetFormToggle(!resetFormToggle)} className=" text-sm font-semibold cursor-pointer hover:underline"> Forget Password</span></h6>
          ...
          <input type="submit" value="Reset PassWOrd" className="btn btn-primary lg:w-full text-white" />
          
               <h6 className=" mt-2"> <span  onClick={()=>setResetFormToggle(!resetFormToggle)} className="text-primary cursor-pointer hover:underline"> Login </span></h6>
        </form>}
