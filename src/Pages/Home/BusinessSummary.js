...
const BusinessSummary = () => {
  return (
    <div className="py-12">
      <div>
        <h1 className="text-center uppercase lg:text-5xl text-2xl text-success">
          Milions business Trust us
        </h1>
        <h2 className="text-center uppercase mt-4 lg:text-2xl">
          try to understand User experience
        </h2>
      ...
      <div className="grid md:grid-cols-4 grid-cols-2 gap-4 py-8">
        <div className="businessCard text-center ">
          <span className="flex justify-center">
            <Icon className="text-success" icon={flag} size={70}></Icon>
          </span>
        ...
        <div className="businessCard text-center ">
          <span className="flex justify-center">
            <Icon className="text-success" icon={desktop} size={70}></Icon>
          </span>
          <h1 className="text-4xl mt-4 mb-2">
            <CountUp end={243} duration={2} />+
          </h1>
          <p className="text-success">Complete Project</p>
        </div>
        <div className="businessCard text-center ">
          <span className="flex justify-center">
            <Icon className="text-success" icon={group} size={70}></Icon>
          </span>
          <h1 className="text-4xl mt-4 mb-2">
            <CountUp end={533} duration={2} />+
          </h1>
          <p className="text-success">Happy Client</p>
        </div>
        <div className="businessCard text-center ">
          <span className="flex justify-center">
            <Icon className="text-success" icon={ic_feedback} size={70}></Icon>
          </span>
          <h1 className="text-4xl mt-4 mb-2">
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 mt-8 gap-8 border-2 p-8">
        <div>
          <h2 className="capitalize lg:text-3xl md:text-2xl text-success">
            have a any question about us or get A product request
          </h2>
          <p className="capitalize lg:text-xl mt-4">
            don't hesitable contact us
          </p>
        </div>
        <div className=" flex  gap-4 flex-col md:flex-row md:items-end md:justify-end">
          <span>
            <button className="btn btn-success capitalize text-white">
              request for quote
            </button>
          </span>
          <span>
